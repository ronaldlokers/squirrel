...
func TestTheWorkerHoldsACaptureWithNoNetwork(t *testing.T) {
	...
	require.Contains(t, body, `"offline=1"`,
		"and the page is told")
	require.Contains(t, body, `"/board/new": "words"`,
		"a capture typed on the board is one it can hold")
	require.Contains(t, body, `"/board/capture": "text"`)
