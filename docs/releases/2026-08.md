...
Shipped release entries for August 2026, moved out of `docs/roadmap.md` to keep
that file to current state rather than history. See `docs/roadmap.md` for what
is next, decided, open, and refused.
